...
Insert into repair values (‘Drive belt replacement’, ‘Engine knock’);
Insert into repair values (‘Spark plugs replacement’, ‘Engine knock’);
Insert into repair values (‘Camshaft replacement’, ‘Engine knock’);
Insert into repair values (‘Valve replacement’, ‘Engine knock’);
Insert into repair values (‘Wheel alignment’, ‘Car drifts in a particular direction’);
Insert into repair values (‘Battery replacement’, ‘Battery does not hold charge’);
Insert into repair values (‘Air filter change’, ‘Black/unclean exhaust’);
Insert into repair values (‘Oil filter change’, ‘Black/unclean exhaust’);
Insert into repair values (‘Catalytic convertor replacement’, ‘Black/unclean exhaust’);
Insert into repair values (‘Drive belt replacement’, ‘A/C-Heater not working’);
Insert into repair values (‘coolant recycle’, ‘A/C-Heater not working’);
Insert into repair values (‘Battery replacement’, ‘A/C-Heater not working’);
Insert into repair values (‘Headlights replacement’, ‘Headlamps/Tail lamps not working’);
Insert into repair values (‘Tail lights replacement’, ‘Headlamps/Tail lamps not working’);
Insert into repair values (‘Turn lights replacement’, ‘Headlamps/Tail lamps not working’);
Insert into repair values (‘Piston replacement’, ‘Check engine light’);
Insert into repair values (‘Gear box repair’, ‘Check engine light’);
Insert into repair values (‘Camshaft replacement’, ‘Check engine light’);
Insert into repair values (‘Valve replacement’, ‘Check engine light’);
